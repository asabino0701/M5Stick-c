# Treino com o algorítimo SVM para identificar o posicionamento do dispositivo m5-Stick-c e 
# teste de acuracidade com matriz de confusão. 
...
dbtrain <- read.csv("https://github.com/asabino0701/M5Stick-c/raw/master/dbtreino_200819.csv")

# Eliminar o primeiro campo por ser um incrementador e não fa parte do treinamento.
dbtrain <- dbtrain[ , -1]
